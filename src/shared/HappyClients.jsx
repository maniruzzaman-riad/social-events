    ...
    return (
        <div className="my-11">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 px-3">
                <div data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" className="text-center border-2 border-purple-700 rounded-lg p-7">
                ...
                <div data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500" className="text-center border-2 border-purple-700 rounded-lg p-7">
